...
/***/ "./src/scripts/components/accordion-list.js":
/*!**************************************************!*\
  !*** ./src/scripts/components/accordion-list.js ***!
  \**************************************************/
...
window.addEventListener('load', () => {
  ...
  ARIAaccordion.create = () => {
    ...
    for (let i = 0; i < widget.length; i++) {
      ...
      const triggers = doc.querySelectorAll(`${childSelector}${widgetHeading} .${widgetTriggerClass}`);
  ...
  ARIAaccordion.setupPanels = function ( /** @type {string} */id, /** @type {NodeListOf<Element>} */panels, /** @type {string} */defaultPanel, /** @type {boolean} */constantPanel) {
  ...
  ARIAaccordion.setupHeadingButton = function ( /** @type {NodeListOf<Element>} */headings, /** @type {boolean} */constantPanel) {
  ...
  ARIAaccordion.togglePanel = function ( /** @type {Event} */e, /** @type {string} */thisAccordion, /** @type {Element} */targetPanel, /** @type {NodeListOf<Element>} */triggers) {
  ...
  ARIAaccordion.keytrolls = function ( /** @type {KeyboardEvent} */e) {
    if ( /** @type {HTMLElement} */e.target.classList.contains(widgetTriggerClass)) {
...
/***/ "./src/scripts/components/fixed-header.js":
/*!************************************************!*\
  !*** ./src/scripts/components/fixed-header.js ***!
  \************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
  ...
  window.addEventListener('scroll', () => {
    ...
    if (direction !== prevDirection) {
      ...
      if (direction === 2 && curScroll > 40) {
        const hiddenheight = header.clientHeight + (headerAlert?.clientHeight || 0);
...
(() => {
  ...
  const plugin = (...pluginArgs) => {
    ...
    const listAccordions = listAccordionArgs => {
      ...
      const node = listAccordionArgs.length <= 0 ? document.documentElement : listAccordionArgs[0];
      return /** @type {Element[]} */(
    ...
    const attach = (...node) => {
      listAccordions(node).forEach(accordion_node => {
        ...
        /** @type {Element[]} */
        const listAccordionsHeader = [].slice.call(accordion_node.querySelectorAll(`.${childClassName}`));
        listAccordionsHeader.forEach((header_node, index_header) => {
          ...
          header_node.classList.add(prefixClassName + CONFIG.ACCORDION_TITLE_STYLE);
...
/***/ "./src/scripts/components/page-navigation.js":
/*!***************************************************!*\
  !*** ./src/scripts/components/page-navigation.js ***!
  \***************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
window.addEventListener('load', () => {
  ...
  if (pagenav && pagenav.childNodes.length === 0 && h2heading) {
    ...
    const onthispage = '<div id="on-this-page-navigation-label" class="label">On this page</div>';
...
/***/ "./src/scripts/components/side-navigation.js":
/*!***************************************************!*\
  !*** ./src/scripts/components/side-navigation.js ***!
  \***************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
window.addEventListener('load', () => {
  ...
  /** @type {HTMLElement} */
  let mobileSideNavDiv, /** @type {HTMLDivElement} */mobileSideNavCont, /** @type {HTMLButtonElement} */sidenavToggleBtn;
...
/***/ "./src/scripts/components/sourcecode.js":
/*!**********************************************!*\
  !*** ./src/scripts/components/sourcecode.js ***!
  \**********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
  ...
  function copyCode( /** @type {Element} */btnElem) {
    ...
    if (codeblock) {
      ...
      if (codeblock.tagName.toLowerCase() === 'pre') {
        ...
        //TextArea
        navigator.clipboard.writeText( /** @type { HTMLTextAreaElement} */codeblock.value);
      }
      // select the text
...
/* harmony import */ var _components_navigation_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/navigation.js */ "./src/scripts/components/navigation.js");
...
/* harmony import */ var _components_sourcecode_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/sourcecode.js */ "./src/scripts/components/sourcecode.js");
/* harmony import */ var _components_tabs_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/tabs.js */ "./src/scripts/components/tabs.js");
/* harmony import */ var _components_number_counter_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/number-counter.js */ "./src/scripts/components/number-counter.js");
/* harmony import */ var _components_return_top_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/return-top.js */ "./src/scripts/components/return-top.js");
/* harmony import */ var _components_side_navigation_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/side-navigation.js */ "./src/scripts/components/side-navigation.js");
/* harmony import */ var _components_external_link_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/external-link.js */ "./src/scripts/components/external-link.js");
/* harmony import */ var _components_page_navigation_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/page-navigation.js */ "./src/scripts/components/page-navigation.js");
/* harmony import */ var _components_pagination_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/pagination.js */ "./src/scripts/components/pagination.js");
/* harmony import */ var _components_mobile_controls_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/mobile-controls.js */ "./src/scripts/components/mobile-controls.js");
